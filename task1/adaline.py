...
class Traning:
    ...
    @classmethod
    def traningFun(self, b, m, n, _Xtrain, _Ytrain,thershold):
        ...
        counter=0
        #thershold=False
        MS_error=sys.float_info.max
        print(MS_error)
        while (counter < m ) and (MS_error > thershold):
            err=0
            MS_error = 0.0
            counter+=1
            ...
            for x, y in zip(_Xtrain, _Ytrain):
                ...
                _A = _Z
                _L = y - _A
                self.train_errors_.append(_L)

            train_error_count=0
            for i in self.train_errors_:
                MS_error+=i**2
                train_error_count+=1
            MS_error/=train_error_count
            print("mse")
    ...
    @classmethod
    def run(self,_F1, _F2, _C1, _C2, n, m, b,thershold):
        ...
        _L, _W, _A, train_errors_list = Traning.traningFun(b, m, n, _xtran, _ytrain,thershold)
...
if __name__ == '__main__':
    ...
    n = 0.00001
    m = 500
    Traning.run(_F1,_F2,_C1,_C2,n,m,b,thershold)
